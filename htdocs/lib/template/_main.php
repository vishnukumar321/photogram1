...
<main>
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      ...
      ?>
      <center>
        <div style="border: 1px solid #ffffff42;padding: 22px; width: 85%;border-radius: 20px;">
          <form action="/" method="post" style="width: 78%;">
      ...
      ?>
        <div class="col-lg-6 col-md-8 mx-auto">
          ...
          <p>
            ...
            <a href="/signup.php" class="btn btn-secondary my-2">Signup</a>
          </p>
        </div>
      <?php
      }
